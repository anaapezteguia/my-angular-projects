...
export class ReactivoComponent implements OnInit {
  ...
  constructor() {
    this.formulario = new FormGroup({
      ...
      username: new FormControl('angel', [
        Validators.required,
        CustomValidators.esStarkConParams([
          'robb',
          'arya',
          'bran',
          'rickon',
      ...
      groupPasswords: new FormGroup(
        {
          ...
          repetirPassword: new FormControl('1234', [
            Validators.required,
            Validators.minLength(4),
            CustomValidators.repetirPassword('password'),
          ]),
        },
  ...
  hayQuePintarErrores(name: string): boolean {
    return (
      this.formulario.controls[name].invalid &&
      this.formulario.controls[name].dirty
    );
  }
